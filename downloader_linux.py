	...
	if action != "quit":
		while not options in ["A", "a", "V", "v", "quit"]:
			...
			if options == "A" or options == "a":
				ytdl_opts = {"ffmpeg_location":"ffmpeg-git-20210528-amd64-static/ffmpeg", "format":"bestaudio/best",
				 "postprocessors": [{
				...
				ytdl_opts = {"ffmpeg_location":"ffmpeg-git-20210528-amd64-static/ffmpeg",
				 "postprocessors": [{
